...
The `1.11.2` development workspace provides shared model and core boundaries, a `clap`
...
composes through the Monas ``0.3.0`` authenticated forwarding/login shell and a
