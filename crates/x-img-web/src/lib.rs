    ...
    html! {
        <div class="mn-app-shell ximg-shell">
            ...
            <main id="main" class="mn-app-main ximg-shell__main" tabindex="-1">
                ...
                <section class="ximg-filters" aria-label="Browse metadata filters"><label>{"Search metadata "}<input placeholder="Account, media type, date"/></label><p>{"Filters: all records · server-side metadata search pending catalogue API"}</p></section>
